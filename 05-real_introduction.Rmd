...
Một khi chúng ta giả thiết rằng hàm f là hàm tuyến tính, việc ước lượng các tham số của hàm f khá là đơn giản và đã có rất nhiều phương pháp làm điều này, chúng ta sẽ tìm hiểu kỹ hơn về cách ước lượng các tham số $\beta$ trong phần sau.
